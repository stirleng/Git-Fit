...
export default function Home(props) {
    ...
    async function CompletePlan() {
        ...
        const workoutType = workout.Category;
        let localADC = userArmsDayCount;
        let localCDC = userChestDayCount;
        let localLDC = userLegDayCount;
    ...
    return (
        ...
        <div className='HomePageButtonContainer'>
            <Link to="/workouts">
                <button type="button" className='HomePageButtons WorkoutsPageButton'>
                    Your Workouts
                    <br></br>
                    <img src={require('../assets/images/barbell_image.png')} className='BarbellImage'/>
            ...
            <Link to="/meals">
                <button type="button" className='HomePageButtons MealsPageButton'>
                    Your Meals
                    <br></br>
                    <img src={require('../assets/images/apple_image.png')} className='AppleImage'/>
                    <div className='NavFromHomeArrow'>
                        &#8594;
                    </div>
                </button>
        ...
        <div id='HomePageSuggestionAndCompletionContainer'>
            ...
            <button id='HomePageCompleteSuggestionButton' onClick={() => {
                CompletePlan()
            }}>
                Complete Plan
            </button>
        ...
        <div id="message_container">
            <h1 id="welcome_message">Welcome back, {user.Name}! It has been {daySinceStart} days since you started this
                journey!</h1>
        </div>
